---
title: 3.2 Text
description: A guide to using the text widget in Ingenuity 7.
sidebar:
    order: 3
---

To add text to your dashboard, drag and drop the text widget from the
widget menu into the grid. 

![Text Widget](~/assets/dashboards/image33-1.png)

You can edit this component in two ways: by double clicking within the dashboard or through configuring the widget settings.

**Option 1:** 

Double click to edit the text component straight from the edit mode in the dashboard.

![Text Widget](~/assets/dashboards/image33-2.png)

Highlight some text to open formatting options. From this toolbar you can do all the traditional formatting options. 

![Text Widget](~/assets/dashboards/image33-3.png)

**Option 2:**

Under the "Text Editor" section you can
