...
The assets tab in the top left menu of the dashboard allows you to create Model Driven dashboards. Model Driven Dashboards take their configuration from objects (Assets)
...
Any component/widget can be configured to use the Asset Control data source
